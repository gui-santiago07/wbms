...
const ControlButton: React.FC<ControlButtonProps> = ({ label, icon, onClick, colorClass, isActive }) => {
  ...
  return (
    <button
      onClick={onClick}
      className={`flex-1 flex flex-col items-center justify-center p-4 rounded-lg text-white font-bold uppercase tracking-wider transition-transform transform hover:scale-105 focus:outline-none ${colorClass} ${activeClasses}`}
    >
      {icon}
...
const MachineControls: React.FC = () => {
  ...
  return (
    <Card className="p-6">
        <h3 className="text-lg font-semibold text-white mb-4">Machine Controls</h3>
        <div className="grid grid-cols-5 gap-4">
            <ControlButton 
                label="Running" 
                icon={<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><polygon points="6 3 20 12 6 21 6 3"/></svg>}
            ...
            <ControlButton 
                label="Down" 
                icon={<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="m21.73 18-8-14a2 2 0 0 0-3.46 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3Z"/></svg>}
                onClick={setDown}
            ...
            <ControlButton 
                label="Pause" 
                icon={<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><rect x="6" y="4" width="4" height="16"/><rect x="14" y="4" width="4" height="16"/></svg>}
                onClick={setPaused}
            ...
            <ControlButton 
                label="Call for Help" 
                icon={<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2a10 10 0 1 0 10 10A10 10 0 0 0 12 2zm1 15h-2v-2h2zm0-4h-2V7h2z"/></svg>}
